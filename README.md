...
> **v2.1.19**: Aumento del límite de paginación a 100 resultados en GitHub API para poder encontrar tags antiguos que contienen archivos estáticos (como los modelos ONNX de vs-mlrt).
